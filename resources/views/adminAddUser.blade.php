            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <hr class="my-0" />
                        <div class="card-body">
                            <form id="formAccountSettings" method="POST" action="/dashboard/add-user"
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="form-control" type="text" id="firstName" name="email" value=""
                                            autofocus />
                                            <label for="firstName" class="form-label">Role</label>
                                        <input class="form-control" type="text" id="firstName" name="role" value=""
                                            autofocus />
                                            <label for="firstName" class="form-label">Password</label>
                                        <input class="form-control" type="text" id="firstName" name="password" value=""
                                            autofocus />
                                    </div>
