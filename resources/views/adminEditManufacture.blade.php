            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <hr class="my-0" />
                        <div class="card-body">
                            <form id="formAccountSettings" method="POST" action="/edit-manufacture/{{$manufacture->manu_id}}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        <label for="firstName" class="form-label">Manu_Name</label>
                                        <input class="form-control" type="text" id="firstName" name="manu_name" value="{{$manufacture->manu_name}}"
                                            autofocus />
                                    </div>
